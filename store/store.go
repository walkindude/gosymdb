...
// directly. This allows alternative backend implementations without touching
// any query logic.
//
// Stability: gosymdb is v0.x. This package is publicly exported to support
// alternative Store implementations, not to provide a stable library API.
// Breaking changes to these interfaces and DTO types may land on any minor
// release until v1.0.
package store
